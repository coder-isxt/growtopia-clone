(() => {
  ...
  function syncMobileOverlayVisibility() {
    ...
    const showChatPanel = inWorld && !gameShellEl.classList.contains("hidden");
    chatPanelEl.classList.toggle("hidden", !showChatPanel);
    chatPanelEl.classList.toggle("open", isChatOpen);
  ...
  if (chatModule && typeof chatModule.initDraggableChat === "function") {
    chatModule.initDraggableChat();
  }
