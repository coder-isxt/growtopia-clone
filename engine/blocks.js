...
window.GTModules.blocks = (function createBlocksModule() {
  ...
  const BLOCK_LIST = [
    ...
    { id: 9, key: "world_lock", name: "World Lock", color: "#ffd166", solid: true, durability: 10, worldLock: true, lockValue: 1, lockAutoConvert: true, icon: "WL", faIcon: "fa-solid fa-lock", image: "special/world_lock.png" },
    { id: 10, key: "door_block", name: "Door Block", color: "#5fc2ff", solid: false, durability: 2, icon: "DB", faIcon: "fa-solid fa-door-open", image: "special/door.png" },
    ...
    { id: 17, key: "vending_machine", name: "Vending Machine", color: "#4d6b8b", solid: false, durability: 7, icon: "VM", faIcon: "fa-solid fa-store", image: "special/vending.png" },
    { id: 18, key: "sign_block", name: "Sign", color: "#b98a58", solid: false, durability: 2, icon: "SG", faIcon: "fa-solid fa-signs-post", image: "special/sign_block.png" },
    { id: 19, key: "anti_gravity_generator", name: "Anti Gravity Generator", color: "#6de9ff", solid: false, durability: 7, icon: "AG", faIcon: "fa-solid fa-meteor" },
    { id: 20, key: "camera_block", name: "Camera", color: "#8eb7d6", solid: true, durability: 6, icon: "CM", faIcon: "fa-solid fa-video", image: "special/camera.png" },
    { id: 21, key: "weather_machine", name: "Weather Machine", color: "#7aa8d9", solid: false, durability: 6, icon: "WM", faIcon: "fa-solid fa-cloud-sun-rain", image: "special/weather_machine.png" },
    { id: 22, key: "display_block", name: "Display Block", color: "#314154", solid: true, durability: 4, icon: "DP", faIcon: "fa-regular fa-square" },
    ...
    { id: 34, key: "donation_box", name: "Donation Box", color: "#8f6d4f", solid: true, durability: 7, donationBox: true, icon: "DN", faIcon: "fa-solid fa-box-open", image: "special/donation_block.png" },
    { id: 36, key: "storage_chest", name: "Storage Chest", color: "#7f5f3e", solid: true, durability: 7, chestStorage: true, icon: "CH", faIcon: "fa-solid fa-box-archive", image: "special/chest.png" },
