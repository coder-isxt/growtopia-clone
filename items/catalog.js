...
window.GTModules.itemCatalog = (function createItemCatalogModule() {
  ...
  const DATA = {
    blocks: [
      ...
      { id: 54, key: "mannequin_block", name: "Mannequin Block", color: "#8f7f71", solid: true, durability: 4, alwaysDrop: true, icon: "MN", faIcon: "fa-solid fa-user" },
      ...
      { id: 43, key: "ruby_lock", name: "Ruby Lock", color: "#e0115f", solid: true, durability: 25, worldLock: true, lockValue: 1000000, lockAutoConvert: true, alwaysDrop: true, icon: "RL", faIcon: "fa-solid fa-gem", image: "special/ruby_lock.png" },
